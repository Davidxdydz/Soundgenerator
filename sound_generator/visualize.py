...
def plot_waveforms(original_sounds, predicted_sounds, original_frequencies, predicted_frequencies, t_range = (0,1)):
    """
    ...
    for n, (os,ps,of,pf) in enumerate(zip(original_sounds,predicted_sounds,original_frequencies,predicted_frequencies)):
        x = n%width
        y = n//width
        ax = axes[y][x]
